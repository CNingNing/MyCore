...
namespace Winner.Persistence.Compiler.MySql
{
    public class MySqlUnitofwork : UnitofworkBase
    {
        ...
        public MySqlUnitofwork(OrmDataBaseInfo ormDataBase, IList<SaveInfo> infos, ISaveCompiler saveCompiler)
        {
            Connection = new MySqlConnection(ormDataBase.ConnnectString);
        ...
        {
            Connection = GetConnnection<MySqlConnection>(OrmDataBase.GetAllSetOrmDataBase());
        }
        ...
        {
            var sqlcmd = new MySqlCommand {Connection = Connection, Transaction = Transaction};
            return sqlcmd;
        }
