...
namespace Component.ThirdPartySdk
{
    ...
    public class QqSdk
    {
        ...
        public virtual string GetToken(string code, string redirecturl)
        {
        ...
        public virtual string GetAuthorityOpendIdAndUnionId(string token)
        {
        ...
        public virtual string GetUserInfo(string token, string openId)
        {
            if (string.IsNullOrWhiteSpace(token) || string.IsNullOrWhiteSpace(openId)) return "";
