...
{
    public class OracleUnitofwork : UnitofworkBase
    {
        #region 属性
        /// <summary>
        /// 执行的命令
        ...
        public OracleUnitofwork(OrmDataBaseInfo ormDataBase, IList<SaveInfo> infos, ISaveCompiler saveCompiler)
        {
            Connection = new OracleConnection(ormDataBase.ConnnectString);
        ...
        {
            Connection = GetConnnection<OracleConnection>(OrmDataBase.GetAllSetOrmDataBase());
        }
        /// <summary>
        /// 重写创建
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual OracleCommand GetOracleCommand()
        {
            var sqlcmd = new OracleCommand {Connection = Connection, Transaction = Transaction};
            return sqlcmd;
        }
        /// <summary>
        /// 关闭
