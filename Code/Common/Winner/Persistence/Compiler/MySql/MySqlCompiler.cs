...
{
    public class MySqlCompiler : CompilerBase
    {        /// <summary>
        /// 转换对象实例
        /// </summary>
        ...
        /// 转换对象实例
        /// </summary>
        public override ISaveCompiler SaveCompiler { get; set; } = new MySqlSaveCompiler();
        /// <summary>
        /// 解析查询实例
        /// </summary>
        public override IQueryCompiler QueryCompiler { get; set; } = new MySqlQueryCompiler();
        #region 构造函数
        /// <summary>
        /// 无参数
        /// </summary>
        ...
        public MySqlCompiler(IFill fill, ISaveCompiler saveCompiler, IQueryCompiler findCompiler)
        ...
        public override void AddUnitofwork(OrmDataBaseInfo ormDataBase, SaveInfo info, IList<IUnitofwork> unitOfWorks)
        {
            ...
            unitOfWorks.Add(new MySqlUnitofwork(ormDataBase, new List<SaveInfo> { info }, SaveCompiler));
        }
        ...
        public override T ExecuteQuery<T>(OrmDataBaseInfo ormDataBase, string commandText, CommandType commandType, params object[] parameters)
        {
            ...
            using (var sqlcon = GetConnnection<MySqlConnection>(ormDataBase.GetAllGetOrmDataBase(),null))
            {
        ...
        public override int ExecuteCommand(OrmDataBaseInfo ormDataBase, string commandText, CommandType commandType, params object[] parameters)
        {
            ...
            using (var sqlcon = GetConnnection<MySqlConnection>(ormDataBase.GetAllSetOrmDataBase(), null))
            {
                var sqlcmd = new MySqlCommand();
                sqlcmd = FillCommandTypeCommand(sqlcmd, commandText,commandType, parameters);
                sqlcmd.Connection = sqlcon;
        ...
        /// <param name="commandType"></param>
        /// <param name="parameters"></param>
        protected virtual MySqlCommand FillCommandTypeCommand(MySqlCommand sqlcmd, string commandText, CommandType commandType, params object[] parameters)
        {
        ...
        /// <returns></returns>
        protected virtual T GetInfosByCommand<T>(OrmDataBaseInfo ormDataBase, OrmObjectInfo obj, MySqlCommand cmd, QueryInfo query)
        {
            if (string.IsNullOrEmpty(cmd.CommandText))return default(T);
            using (var sqlcon = GetConnnection<MySqlConnection>(ormDataBase.GetAllGetOrmDataBase(), query))
            {
        ...
        /// <param name="sqlcmd"></param>
        /// <returns></returns>
        protected virtual T GetInfosByType<T>(QueryInfo query, OrmObjectInfo obj, MySqlCommand sqlcmd)
        {
        ...
        {
            return new MySqlConnection(ormDataBase.ConnnectString) as T;
        }
